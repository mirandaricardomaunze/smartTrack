/**
 * @file db.js
 * @description Pool de conexões PostgreSQL do payments-service.
 *
 ...
 *
 * Cada microsserviço tem a SUA base de dados (default: payments_db).
...
const pool = new Pool({
  ...
  database: process.env.PGDATABASE || 'payments_db',
