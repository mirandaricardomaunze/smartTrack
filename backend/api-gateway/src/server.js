...
const operationsRouter = require('./api/operations.router');
const profitabilityRouter = require('./api/profitability.router');
...
const predictionsRouter = require('./api/predictions.router');
...
app.use('/v1/profitability', profitabilityRouter);
